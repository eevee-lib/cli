...
const { isObject } = require('@eevee-cli/util');
const formatPath = require('@eevee-cli/format-path');
const { getDefaultRegistry, getNpmLatestVersion } = require('@eevee-cli/get-npm-info');
...
class Package {
    ...
    async prepare () {
        ...
        //_@eevee-cli_init@1.1.2@@eevee-cli
        //@eevee-cli/init 1.1.2
    }
