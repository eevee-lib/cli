...
// const init = require('@eevee-cli/init');
const exec = require('@eevee-cli/exec');
...
async function core () {
    try {
        ...
        console.log('debug111', process.env.LOG_LEVEL);
...
async function checkGlobalUpdate () {
    ...
    //2.调用npm API,获取所有版本号
    const { getNpmSemverVersion } = require("@eevee-cli/get-npm-info");
